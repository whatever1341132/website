...
| ----- | ----------- | -------------------------------------------------------------------------------- | --------------------------------------------------- |
| 5544  | TCP (HTTPS) | [orderflow-proxy](https://www.notion.so/1066b4a0d876808e9aebca8b8ee2b99f?pvs=21) | Receive orderflow from builder nodes and Flashbots. |
...
| Port | Protocol         | Service                                                                                       | Use                                                   |
| ---- | ---------------- | --------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| 443  | TCP (HTTPS)      | [orderflow-proxy](https://www.notion.so/1066b4a0d876808e9aebca8b8ee2b99f?pvs=21)              | Orderflow from operator, users, wallets, etc.         |
...
| Port  | Protocol   | Service                                                                          | Use                                                                                                                                                                                            |
| ----- | ---------- | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 14727 | TCP (HTTP) | [orderflow-proxy](https://www.notion.so/1066b4a0d876808e9aebca8b8ee2b99f?pvs=21) | Serving `GET /cert` REST API which is used by cvm-proxy on port 7936.                                                                                                                          |
...
| 443   | Orderflow Proxy | Operator, optionally for users | Receive orderflow from operator, users, wallets.                    |
