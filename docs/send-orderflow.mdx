...
Orderflow sent to [Flashbots Protect](https://protect.flashbots.net) and [Flashbots Bundle Relay](https://docs.flashbots.net/flashbots-auction/advanced/rpc-endpoint) is shared with BuilderNet. You can also send orderflow directly to a BuilderNet node, and optionally validate the TEE proof.
