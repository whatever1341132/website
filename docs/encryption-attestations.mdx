...
You can use [this tool](https://github.com/flashbots/cvm-reverse-proxy/blob/get-measurements/cmd/get-measurements/main.go) to get the certificate with TEE attestation:
