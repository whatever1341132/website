...
The [System API](system-api) is the exclusive interface between operators and the TDX services, and includes limited but useful information such as service healthchecks.
